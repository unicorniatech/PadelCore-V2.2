/*
  # Improve Profile Creation and Username Generation

  1. Changes
    - Add better username generation with validation
    - Improve profile creation error handling
    - Add better indexes for username search
    - Update constraints for username format
